...
const ReusableCards = ({ type, location, data, onUpdate }) => {
  ...
  useEffect(() => {
    ...
    const EntityArray = parsedPicklists[4]?.values || [];
    const entitymapped = EntityArray.map((c) => ({
      id: c.id,
      label: c.value,
    }));
    setEntityStructureoption(entitymapped);

    const buyerTypeArray = parsedPicklists[7]?.values || [];
    const buyerTypemapped = buyerTypeArray.map((c) => ({
      id: c.id,
      label: c.value,
    }));
    settypeofbuyerOption(buyerTypemapped);
    ...
    setBusinessCategoryoption(businessCategorymapped);
  }, []);
...
valueToset=selectedValue.map((item)=>item.label);
    }
else{
  valueToset=selectedValue
    ...
    setFormData((prev) => {
      ...
      if (field === "country" || field.endsWith("Country")) {
        const stateKey =
          field === "country" ? "state" : field.replace("Country", "State");
        const cityKey =
          field === "country" ? "city" : field.replace("Country", "City");
      ...
      if (field === "state" || field.endsWith("State")) {
        const cityKey =
          field === "state" ? "city" : field.replace("State", "City");
        next[cityKey] = ""; // reset city
      }
    ...
    if (field === "country" || field.endsWith("Country")) {
      const countryId =
        typeof selectedValue === "object" ? selectedValue.id : null;
  ...
  const handleSellerSave = async () => {
    ...
    const payload = {
      ...
      debt: formData.debt,
      salereason: formData.salereason.value,
      askingPrice: formData.askingPrice,
      preferredArrangement:formData.preferredArrangement
      // preferredArrangement: formData.preferredArrangement.map((item)=>item.label) ||formData.preferredArrangement ,
  //   preferredArrangement: {type==="modal"
  // ? formData.preferredArrangement:formData.preferredArrangement.map(item => item.label)},
  ...
  const handleSave = async () => {
    ...
    //     : "https://bizplorers-backend.onrender.com/api/seller/update_detail";
    const payload = {
      typeOfBuyer: formData.typeOfBuyer.value,
      ...
      businesslocationCountry: (() => {
        ...
        return (
          buyerCountries.find((c) => String(c.id) === String(existing))
            ?.label || ""
        );
      })(),
      ...
      Edit
                      ...
                      >
                        ...
                        <EditableRow
                          ...
                          editable={editBuyerMode}
                          onChange={(v) =>
                            handleBuyerChange("linkedinProfile", v)
                          }
                        />
                        <EditableRow
                          label="Description"
                      ...
                      <CollapsibleSection
                        ...
                        onToggle={() =>
                          setOpenSection(
                            openSection === "preferences" ? "" : "preferences"
                          )
                        }
                      >
                        <EditableRow
                          ...
                          editable={editBuyerMode}
                          onChange={(v) =>
                            handleBuyerChange("ticketSizeMin", v)
                          }
                        />
                        <EditableRow
                          ...
                          editable={editBuyerMode}
                          onChange={(v) =>
                            handleBuyerChange("ticketSizeMax", v)
                          }
                        />
                        ...
                        <EditableRow
                          ...
                          editable={editBuyerMode}
                          onChange={(v) =>
                            handleBuyerChange("openToPreRevenue", v === "Yes")
                          }
                          options={["Yes", "No"]}
                        />
                        <EditableRow
                          ...
                          editable={editBuyerMode}
                          onChange={(v) =>
                            handleBuyerChange("openToPreBreakeven", v === "Yes")
                          }
                          options={["Yes", "No"]}
                        />
                        <div className="my-3">
                          ...
                          {editBuyerMode ? (
                            ...
                            <div>
                              {(formData?.businessCategories ?? []).join(
                                ", "
                              ) || "N/A"}
                            </div>
                          )}
                        ...
                        <div className="my-3">
                          ...
                          {editBuyerMode ? (
                            ...
                            <div>
                              {(formData?.preferredArrangement ?? []).join(
                                ", "
                              ) || "N/A"}
                            </div>
                          )}
  ...
  /> */}
                        <div className="my-3 flex gap-2">
                          ...
                          {editBuyerMode ? (
                            ...
                            <>
                              <div>
                                {formData.businesslocationCountry || "N/A"}
                              </div>
                            </>
                          )}
                        </div>
                        ...
                        <div className="my-3 flex gap-2">
                          ...
                          {editBuyerMode ? (
                            ...
                            <>
                              ...
                              <div>
                                {(formData?.businesslocationCities ?? []).join(
                                  ", "
                                ) || "N/A"}
                              </div>
                            </>
          ...
          <div className="w-[350px] px-5 py-5 min-h-[420px] border-2 border-slate-300 rounded-md p-4 bg-white shadow-lg shadow-slate-400">
            ...
            <div className="p-4 bg-slate-100 space-y-2 my-3">
              ...
              <div className="flex justify-between text-[15px]">
                ...
                <span>{data?.NETtrailing12months}</span>
              </div>
            </div>
      ...
      Edit
                      ...
                      >
                        {location === "dashboard" ? (
                          <>
                            ...
                            <EditableRow
                              ...
                              editable={editSellerMode}
                              onChange={(v) =>
                                handleChange("company_linkedin", v)
                              }
                            />
                          </>
                        ) : null}
                        ...
                        <EditableRow
                          ...
                          editable={editSellerMode}
                          onChange={(v) =>
                            handleChange("description_business", v)
                          }
                          type="textarea"
                        />
                        <EditableRow
                          ...
                          //  dropdownOptions={dropdownOptions.businessCategory}
                          options={businessCategoryoption.map(
                            (item) => item.label
                          )} // <- array of {id,label} coming from API
                        />
                        ...
                        <EditableRow
                          ...
                          options={entityStructureoption.map(
                            (item) => item.label
                          )}
                        />
                      </CollapsibleSection>
                      ...
                      <CollapsibleSection
                        ...
                        onToggle={() =>
                          setOpenSection(
                            openSection === "financial" ? "" : "financial"
                          )
                        }
                      >
                        <EditableRow
                        ...
                        <EditableRow
                          ...
                          editable={editSellerMode}
                          onChange={(v) =>
                            handleChange("NETlastFinancialYear", v)
                          }
                        />
                        <EditableRow
                          ...
                          editable={editSellerMode}
                          onChange={(v) =>
                            handleChange("NETtrailing12months", v)
                          }
                        />
                        <EditableRow
                        ...
                        <EditableRow
                          ...
                          editable={editSellerMode}
                          onChange={(v) =>
                            handleChange("positiveCashFlow", v === "Yes")
                          }
                          //  options={["Yes", "No"]}
                          options={["Yes", "No"]}
                        />
                      ...
                      <CollapsibleSection
                        ...
                        isOpen={openSection === "exit"}
                        onToggle={() =>
                          setOpenSection(openSection === "exit" ? "" : "exit")
                        }
                      >
                        <EditableRow
                          label="Reason for Sale"
                          // value={formData.salereason}
                          //  value={formData.salereason?.toString()}
                          value={formData.salereason}
                        ...
                        <EditableRow
                          ...
                          editable={editSellerMode}
                          onChange={(v) =>
                            handleChange("preferredArrangement", v)
                          }
