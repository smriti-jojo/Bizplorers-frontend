  ...
  return (
    <div className='relative'>
      <div className='w-[350px] border-2 border-slate-300 rounded-md p-4 '>
        ...
        <h1 className='font-semibold text-lg py-1'>For Sale: Profitable Chennai Based Kerala Restaurant</h1>
     ...
     <div className='flex gap-3 py-1'>
      <div>
        the restaurant is a highly profitable and highly rated kerala cuisine restaurant located in ...
      </div>
      <div>
        <img src={place} alt='image' width={300}/>
      </div>
     </div>
     <div className='py-1 '>
<StarIcon fontSize='small' className='mr-1 text-yellow-400'/>8.2 <span className='ml-3'><LocationPinIcon fontSize='small' className='mr-1 text-red-500'/>Chennai</span>
     </div>
  ...
  <h1 className="text-2xl font-bold">40L</h1>
</div>
