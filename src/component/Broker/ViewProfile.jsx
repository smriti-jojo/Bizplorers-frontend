...
country:brokerData.country.label,
state:brokerData.state.label,
        city:brokerData.city.label,
    ...
    <div>
      ...
      {/* <div className='flex justify-center'>
        ...
        <div className="flex flex-col border rounded-md  px-6 w-full m-4 max-w-screen-md bg-white shadow-lg shadow-slate-100">
         ...
         <EditableRow label="Country" icon={<CheckBoxIcon className='!text-green-600 mr-1' />} value={brokerData.country} editable={isEditing} onChange={(val) => handleChange('country', val)} options={picklistData[2]?.values}/>
